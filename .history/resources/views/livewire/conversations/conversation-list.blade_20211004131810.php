<div>
    @forelse ($conversations as $conversation )
        ...
        <a href="{{ route('conversation.show',[$conversation->uuid]) }}" class="list-group-item list-group-item-action {{\Str::contains(request()->path(),$conversation->uuid)? active text-white : text-white }} rounded-0">
