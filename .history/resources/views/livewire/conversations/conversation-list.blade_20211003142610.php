<div>
    @forelse ($conversations as $conversation )
        ...
        <a href="{{ route('conversation.show',[$conversation]) }}" class="list-group-item list-group-item-action active text-white rounded-0">
            <div class="media"><img src="{{ asset('images/avatar.jpg') }}" alt="user" width="50"
                    class="rounded-circle">
                <div class="media-body ml-4">
                    <div class="d-flex align-items-center justify-content-between mb-1">
                        {{ $conversation->name? $conversation->name:$conversation->users->pluck('name')->join(', ') }}</h6><small class="small font-weight-bold">25 Dec</small>
                    </div>
